...
public class CouchSession {
	...
	//protected Log log = LogFactory.getLog(CouchSession.class);
 ...
 protected HttpParams httpParams;
	 ...
	 * @param pass - password
	 */
	public CouchSession(String host, int port, String user, String pass) {
	 ...
	 * @param port
	 */
	public CouchSession(String host, int port) {
	 ...
	 * @param secure
	 */
	public CouchSession(String host, int port, boolean secure) {
	...
	public CouchDatabase getDatabase(String name) {
		...
		if (resp.isOk()) {
			return new CouchDatabase(resp.getBodyAsJSONObject(),this);
		} else {
	 ...
	 */
	public boolean deleteDatabase(CouchDatabase db) {
