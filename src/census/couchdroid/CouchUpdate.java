...
public class CouchUpdate {
     ...
     */
    public CouchUpdate(String name) {
        this.name = name;       
        docId = null;
        usePOST = false;
     ...
     * @param docId
     */
    public CouchUpdate(String name, String docId) {
        this.name = name;
        this.docId = docId;
        usePOST = false;
        params = new ArrayList<NameValuePair>();
     ...
     * @param usePOST
     */
    public CouchUpdate(String name, String docId, boolean usePOST) {
        this.name = name;
        this.docId = docId;
